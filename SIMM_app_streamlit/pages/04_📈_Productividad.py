...
def mostrar_cartera(fecha_inicio, fecha_fin, db):
    ...
    fecha_inicio_com = fecha_inicio - relativedelta(months=1) + timedelta(days=1)
    fecha_fin_com = fecha_fin_ajustada - relativedelta(months=1) + timedelta(days=1)
    fecha_inicio_com2 = fecha_inicio - relativedelta(months=2) + timedelta(days=1)
    fecha_fin_com2 = fecha_fin_ajustada - relativedelta(months=2) + timedelta(days=1)
...
def main():
    ...
    st.info(f"Rango de comparación 2 períodos atrás: {fecha_inicio_comparacion - relativedelta(months=1)} a {fecha_fin_comparacion - relativedelta(months=1)}"  )
